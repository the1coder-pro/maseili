...
const textTheme = TextTheme(
  displayLarge:
      TextStyle(fontFamily: "Lateef", fontSize: 57, letterSpacing: 0),
  displayMedium:
      TextStyle(fontFamily: "Lateef", fontSize: 45, letterSpacing: 0),
  displaySmall: TextStyle(fontFamily: "Lateef", fontSize: 36, letterSpacing: 0),
  headlineMedium:
      TextStyle(fontFamily: "Lateef", fontSize: 28, letterSpacing: 0),
  headlineSmall:
      TextStyle(fontFamily: "Lateef", fontSize: 24, letterSpacing: 0),
  titleLarge: TextStyle(fontFamily: "Rubik", fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 0),
  titleMedium: TextStyle(fontFamily: "Lateef", fontSize: 16, letterSpacing: 0),
  titleSmall: TextStyle(fontFamily: "Lateef", fontSize: 14, letterSpacing: 0),
  bodyLarge: TextStyle(fontFamily: "Rubik", fontSize: 16, letterSpacing: 0),
  bodyMedium:
      TextStyle(fontFamily: "Rubik", fontSize: 14, letterSpacing: 0),
  labelLarge:
      TextStyle(fontFamily: "Rubik", fontSize: 14, letterSpacing: 0),
  bodySmall: TextStyle(fontFamily: "Rubik", fontSize: 12, letterSpacing: 0),
  labelSmall:
      TextStyle(fontFamily: "Rubik", fontSize: 11, letterSpacing: 0),
);
...
// Color schemes copied from missedPrayerCounter
...
ColorScheme colorSchemeChooser(int color, bool darkMode,
  ...
  switch (MyApp.colorSchemes[color]) {
    case "Purple":
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<GeneralPrefrencesProvider>(
        builder: (context, themeMode, _) => DynamicColorBuilder(
          builder: (ColorScheme? lightDynamic, ColorScheme? darkDynamic) {
            final lightScheme = colorSchemeChooser(
              themeMode.themeColorIndex,
              false,
              deviceLightColorTheme: lightDynamic,
              deviceDarkColorTheme: darkDynamic,
            );

            final darkScheme = colorSchemeChooser(
              themeMode.themeColorIndex,
              true,
              deviceLightColorTheme: lightDynamic,
              deviceDarkColorTheme: darkDynamic,
              ...
              builder: (context, child) {
                return MediaQuery(
                  data: MediaQuery.of(context).copyWith(
                    textScaler: TextScaler.linear(themeMode.fontSize / 21.0),
                  ),
                  child: child!,
                );
              },
